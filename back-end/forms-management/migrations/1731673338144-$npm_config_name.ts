...
export class  $npmConfigName1731673338144 implements MigrationInterface {
    name = ' $npmConfigName1731673338144'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" DROP COLUMN "organizationOrgId"`);
        ...
        await queryRunner.query(`ALTER TABLE "category" ADD "organizationOrgId" uuid`);
