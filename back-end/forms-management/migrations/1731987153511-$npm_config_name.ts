...
export class  $npmConfigName1731987153511 implements MigrationInterface {
    name = ' $npmConfigName1731987153511'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "form_fields" ("fieldId" uuid NOT NULL DEFAULT uuid_generate_v4(), "image" text, "question" text NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_881ec1ba12f49d02621b1d9a933" PRIMARY KEY ("fieldId"))`);
