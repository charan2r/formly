...
export class Init1731743936944 implements MigrationInterface {
    name = 'Init1731743936944'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "category" ("categoryId" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "status" text NOT NULL, "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "organizationOrgId" uuid, CONSTRAINT "PK_8a300c5ce0f70ed7945e877a537" PRIMARY KEY ("categoryId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "category" ADD "status" text NOT NULL`);
